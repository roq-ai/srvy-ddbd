...
import { VendorInteractionListPage as ShowCaseList } from 'pages/vendor-interactions';
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`vendor-interactions`} passHref legacyBehavior>
                  <Button
