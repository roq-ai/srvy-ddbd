  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Srvy, your comprehensive solution for creating, distributing, and analyzing surveys. Empowering researchers with efficient survey tools to gather and interpret meaningful data."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzdXJ2ZXl8ZW58MHx8fHwxNjk0NDgzOTg5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Srvy, your comprehensive solution for creating, distributing, and analyzing surveys. Empowering researchers with efficient survey tools to gather and interpret meaningful data.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Researcher" type="researcher" abilities={appConfig.ownerAbilities} />

                <Card userTypeName="3rd Party Vendor" type="3rd-party-vendor" abilities={appConfig.customerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
