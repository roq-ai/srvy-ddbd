...
import { getVendorInteractionById, updateVendorInteractionById } from 'apiSdk/vendor-interactions';
...
function VendorInteractionEditPage() {
  ...
  const handleSubmit = async (values: VendorInteractionInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateVendorInteractionById(id, values);
      mutate(updated);
      resetForm();
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Update Vendor Interaction',
              isCurrent: true,
            },
          ]}
        />
