...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'survey.create': {
    roles: ['researcher', 'fielder', 'data-processor'],
    key: 'survey-created',
  ...
  'vendor_interaction.create': {
    roles: ['researcher', 'builder', 'fielder', 'data-processor'],
    key: 'vendor-feedback',
    tenantPath: ['organization', 'survey', 'vendor_interaction'],
    userPath: [],
  },
};

const ownerRoles: string[] = ['researcher'];
const customerRoles: string[] = ['3rd-party-vendor'];
const tenantRoles: string[] = ['builder', 'fielder', 'researcher', 'data-processor'];
